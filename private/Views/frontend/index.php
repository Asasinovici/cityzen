...
<div class="g_container">
    <nav class="g_row navbar box">
        ...
        <div class="g_col-12 g_col-sm-9 g_col-lg-10 navlinks">
            ...
            <a class="navitem" href="login.html">
                Autentificare
            </a>
        </div>
        ...
        <div class="event-container" style="background-image: url('assets/img/event.jpg')">
            <div class="event-overlay">
                ...
                <div class="event-description">
                    La patru pinguini cumparati, primesti un babuin!
                </div>
            </div>
        </div>

        <div class="g_row box second-navbar">
            <div class="g_col-12 g_col-md-4 g_col-lg-3 categ-container">
                <a href="index.html" class="categ-button">
                    CATEGORII
                </a>
                <ul class="categ-list">
                    <li class="categ-name">
            ...
            <div class="g_col-12 g_col-md-8 g_col-lg-9">
                <div class="search-container">
                    <input type="text" title="Caută" class="search-input"/>
                        ...
                        <ul class="g_row products-list">
                            ...
                            <li class="g_col-6 g_col-md-4 g_col-lg-3 product-item">
                                <div class="product-wrapper">
                                    ...
                                    <div class="product-data">
                                        <div class="product-name">
                                            Colegul Șantieristului de plastic
                                        </div>
                                        <div class="product-price">
                                            69,69 RON
                                        </div>
    ...
    <footer>
        TOYR WEBSHOP - PROIECT TW - <a href="https://github.com/Asasinovici/cityzen">GITHUB</a>
    </footer>
</div>
</body>
</html>
